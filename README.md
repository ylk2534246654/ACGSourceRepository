...
#### 第一版全网资源扫描(2.56V后已停用，已绝版):
那段时间是光辉历史，因为它让我结识了许多B站朋友，我们组建了六个群，不过现在只有主群活跃。

#### 第二版NRS搜索工具(延续一版，换了开发软件Android Studio，重新开发):
因为现在觉得搜索功能太少，技术水平低，代码乱，bug难修复，已放弃，待停用。
在此感谢各位NRS会员用户一直以来的捐赠。现在的MyACG是第三版了。
