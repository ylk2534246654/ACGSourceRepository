## 捐赠激活
本人致力于开发无广告，无推送，功能强大纯粹而好用的搜索工具，MyACG已经是我重做后的第三版了。<br/>
**第一版全网资源扫描**(2.56V后已停用，已绝版):<br/>
那段时间是光辉历史，因为它让我结识了许多B站朋友，我们组建了六个群，不过现在只有主群活跃。<br/>
**第二版NRS搜索工具**(延续一版，换了开发软件Android Studio，重新开发):<br/>
因为现在觉得搜索功能太少，技术水平低，代码乱，bug难修复，已放弃，待停用。<br/>
在此感谢各位NRS会员用户一直以来的捐赠。现在的MyACG是第三版了。<br/>
**为了让MyACG能够更好，你们的捐赠是对MyACG开发下去的动力，相应的作为报答本人会回馈你们部分扩展功能。**
